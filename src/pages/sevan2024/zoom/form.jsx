...
class AfterCovid19 extends React.Component {
  ...
  handleSubmit = () => {
    ...
    if (error !== "") {
      ...
      fetch(
        "https://www.apis.seasidestartupsummit.com/aplications/after-covid19.php",
        {
          method: "POST",
          headers: {
        ...
        .then((data) => {
          if (data.resp === "ok") {
            ...
            this.setState({
              errorSbm:
                data.resp /*'Sorry something went wrong. Please Try Again'*/,
            });
          }
        })
  ...
  render = () => {
    return (
      <Fragment>
        <Helmet>
          <title>
            Virtual Campfire Talk with Mr. President | Seaside Startup Summit
          </title>
        </Helmet>
          ...
          >
            <div className="form_body_flex" style={{ marginTop: "0px" }}>
              <div>
                ...
                <span style={{ fontSize: "0.9rem", color: "#707070" }}>
                  * Taking into account time constraints of the event and the
                  number of questions, please, be aware that your question may
                  not be included.
                </span>
              </div>
            </div>
