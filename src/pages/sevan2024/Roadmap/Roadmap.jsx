...
import useWindowWidth from "../../../hooks/useWidnowWidth.js";
        ...
        <>
            <div className="wb-applyBlock wb-roadmapBlock sevan2024-roadmapBlock">
                ...
                <div className="roadmap-msg">
                    <p>*If your startup passes the selection, 3 representatives get a free participation voucher.
                        Free <br/> participation does NOT include air tickets and other travel costs.</p>
                </div>
            </div>
            <Popup mobile={width && width < 1024} infoMode={null} status={popupStatus} buttons={buyTickets}
