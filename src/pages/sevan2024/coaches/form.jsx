...
class CoachesForm extends React.Component {
  ...
  handleCurrentStatus = (event) =>
    (this.coach.currentStatus.times = event.target.value);
  ...
  handleExperience = (event) => {
    ...
    let disable;
    if (skills.skill1 !== "" && skills.skill2 !== "" && skills.skill3 !== "")
      disable = true;
    else disable = false;
  ...
  handleExperienceCoach = (event) =>
    (this.coach.experience = event.target.value);
  ...
  handleSubmit = () => {
    ...
    if (error !== "") {
      ...
      fetch(
        "https://www.apis.seasidestartupsummit.com/aplications/coaches.php",
        {
          method: "POST",
          headers: {
    ...
    return (
      <Fragment>
        <div className="teamleadForm_title_body">
          ...
          <p>
            Please complete the form and tell us about you as much as possible.
          </p>
        </div>
        <div className="teamleadForm_title">
          <h3 className="subtitle">Identification</h3>
        </div>
          ...
          <div className="form_body_flex">
            <div ref="birthday">
              <TextField
                ref="firstName"
                name="name"
                onChange={this.handleBasicButtons}
                label="First Name *"
              />
              <TextField
                ref="lastName"
          ...
          <div className="form_body_flex_textbox">
            ...
            <div className="textAreaBox">
              <div>
                <h6 ref="doingInfo">
                  {" "}
                  If working, what is it that you do?{" "}
                  <span ref="textArea1"> (Max 50 words)</span>
                </h6>
              </div>
              <textarea
                onChange={this.handleWorkingText}
                maxLength={this.state.workingTextLenght}
              ></textarea>
            </div>
          </div>
        </div>
        <div className="volunteersForm_title">
          <h3 className="subtitle">Education and Skills</h3>
        </div>
        <div className="form_body">
          ...
          <div className="form_body_grid2" style={{ marginTop: "40px" }}>
            <h4 ref="directions">
              We have three main Coaching directions this year. If you
              participated as a Coach, which one of these would you prefer?
            </h4>
            <RadioGroup
            ...
            >
              ...
              <FormControlLabel
                ...
                control={<Radio color="primary" />}
                label="Business development/ Sales Specialist"
              />
              <FormControlLabel
                value="methodologist"
                control={<Radio color="primary" />}
          ...
          <div className="form_body_flex2">
            <div>
              <h4 ref="skills">
                What are the skills, that you consider yourself strong in? *{" "}
              ...
              <FormGroup>
                ...
                <TextField
                  name="otherSkil"
                  onChange={this.handleBasicButtons}
                  label="Please identify other if needed"
                />
              </FormGroup>
            </div>
          </div>
        ...
        <div className="volunteersForm_title">
          <h3 className="subtitle">
            Relevant Coach Experience & Motivation Questions
          </h3>
        </div>
        <div className="form_body">
          <div className="form_body_grid">
            ...
            <RadioGroup
              ...
              name="experience"
              onChange={this.handleExperienceCoach}
            >
              <FormControlLabel
                value="N/A"
                control={<Radio color="primary" />}
          ...
          <div className="form_body_flex2">
            <div className="form_body_grid">
              ...
              <RadioGroup
                aria-label="startupNum"
                name="startupNum"
                onChange={this.handleStartupnum}
              >
                <FormControlLabel
                  value="N/A"
                  control={<Radio color="primary" />}
            ...
            <div className="form_body_grid">
              ...
              <FormGroup>
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      onChange={this.handlePartisipated}
                      value="SSSholidays UAE RAK"
                      color="primary"
                    />
                  }
                  label="SSSholidays UAE RAK"
                />
                <FormControlLabel
                  name="p1"
                  control={
                    <Checkbox
                      onChange={this.handlePartisipated}
                      value="Sevan Startup Summit 2019"
                      color="primary"
                    />
                  }
                  label="Sevan Startup Summit 2019"
                />
                <FormControlLabel
                  name="p1"
                  control={
                ...
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      onChange={this.handlePartisipated}
                      value="Sevan Startup Summit 2018"
                      color="primary"
                    />
                  }
                  label="Sevan Startup Summit 2018"
                />
                <FormControlLabel
                  name="p3"
                  control={
                    <Checkbox
                      onChange={this.handlePartisipated}
                      value="Seaside Startup Summit 2018: GOA"
                      color="primary"
                    />
                  }
                  label="Seaside Startup Summit 2018: GOA"
                />
                <FormControlLabel
                  name="p4"
                  control={
                    <Checkbox
                      onChange={this.handlePartisipated}
                      value="Seaside Startup Summit 2018: UAE"
                      color="primary"
                    />
                  }
                  label="Seaside Startup Summit 2018: UAE"
                />
                <FormControlLabel
                  name="p5"
                  control={
                    <Checkbox
                      onChange={this.handlePartisipated}
                      value="Sevan Startup Summit 2017"
                      color="primary"
                    />
                  }
                  label="Sevan Startup Summit 2017"
                />
                <FormControlLabel
                  name="p6"
                  control={
                    <Checkbox
                      onChange={this.handlePartisipated}
                      value="Sevan Startup Summit 2016"
                      color="primary"
                    />
                  }
                  label="Sevan Startup Summit 2016"
                />
              </FormGroup>
            </div>
          </div>
          <div className="form_body_flex2">
            <div className="form_body_grid">
              ...
              <RadioGroup
                aria-label="aboutSevan"
                name="aboutSevan"
                onChange={this.handleAboutSevan}
              >
                <FormControlLabel
                  value="Facebook"
                  control={<Radio color="primary" />}
          ...
          <div className="form_body_grid2">
            <div className="textAreaBox long">
              <div>
                <h6 ref="motivation">
                  {" "}
                  What is your motivation to apply to SSS ? *{" "}
                  <span ref="textArea2"> (Max 100 words) </span>
                </h6>
              </div>
              <textarea
                onChange={this.handleMotivationText}
                maxLength={this.state.motivationLenght}
              ></textarea>
            </div>
          </div>
        </div>
