        ...
        <div className="upcommingPrograms_left">
          ...
          <div className="textBox">
            ...
            <div style={{ display: "flex" }}>
              <img
                // src={require("./img/disignIcon/info.png") ?? ""}
                alt="starter program"
                className="textBoxMobileImg"
              />
              <p>
                Sevan Startup Summit is located in one of the most beautiful
                places in Armenia, in an open outdoor camping area. It is
                extremely important to be well prepared.
                <br /> <b>Please check the below links for more information.</b>
              </p>
            </div>
            ...
            <div className="wb-knowMobileButtons">
              {buttonData.slice(0, 2).map((button) => (
                <div
                  key={button.buttonId}
                  className="wb-knowMobileButtons-card"
                >
                  <Link
                    smooth={true}
                    offset={-80}
