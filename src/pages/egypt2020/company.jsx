...
class EgyptCompany extends React.Component {
  ...
  handleparticipateStatus = (event) => {
    let arr =
      this.form.participateAs !== "" ? this.form.participateAs.split(",") : [];
  ...
  handleSubmit = () => {
    ...
    else if (emial === "" || EmailValidator.validate(emial) !== true)
      error = "emial";
    else if (phone === "") error = "phone";
    else if (participate === "") error = "participate";
    else if (participate === "yes" && participateAs === "")
      error = "participateAs";
    ...
    if (error !== "") {
      ...
      fetch(
        "https://www.apis.seasidestartupsummit.com/aplications/egypt2020-company.php",
        {
          method: "POST",
          headers: {
          ...
          <div ref="formelem">
            ...
            <div className="teamleadForm_title">
              <div className="form_body_header">
                <h4 ref="participate">
                  Has your company ever participated in one of Seaside Startup
                  Summits? *
                </h4>
                <RadioGroup
                  aria-label="gender"
            ...
            <div className="form_body">
              <div
                style={{ marginTop: "0px", height: "0px", overflow: "hidden" }}
                className="jarmaDiv"
                ref="participateCond"
              >
                <h4 ref="participateAs">
                  My Company Participated in SSS as a ...?*
                </h4>
                <FormGroup>
                  <FormControlLabel
                    control={
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        onChange={this.handleparticipateStatus}
                        value="Participant of SSS Expo"
                        color="primary"
                      />
                    }
                    label="Participant of SSS Expo"
                  />
                  <FormControlLabel
                    control={
                      <Checkbox
