      ...
      <Fragment>
        ...
        <div className="egipt_2020">
          ...
          <div className="event_part1">
            <div className="left">
              <p>
                <b>#SSSholidays2020</b> is a 7-day event which will take place
                in a resort setting, with representatives of the Startup
                Ecosystem of Armenia and the host country. During these days
                panel discussions will be organized, as well as Campfire Talks,
                etc. Fill in this form to participate in #SSSholidays2020 and
                our organizers will look at your candidacy, contact you and send
                you more detailed information about the event.
              </p>
              <div>
          ...
          <div className="valunteersOppartunitis event_status">
            ...
            <div>
              ...
              <div className="opartunnitisItem">
                ...
                <p>— Networking —</p>
                <small>
                  with fellow creatives who share the same path with
                </small>
              </div>
              <div className="opartunnitisItem">
                <div>
                ...
                <p>— Opportunities —</p>
                <small>
                  ultimate platform to source your next promising deal and have
                  job opportunities
                </small>
              </div>
              <div className="opartunnitisItem">
            ...
            <div className="footer">
              ...
              <p>
                SSSHolidays2020 will be organized for the first time, and we are
                sure that it will be as unique and unprecedented as the main
          ...
          <div className="event_cond valunteersOppartunitis">
            ...
            <small>
              Each of you who helped us to organize SSS became a part of a huge
              team-Family.
            </small>
          </div>
          <div className="event_violet">
            <p>
              SSSHolidays2020 is also a celebration of the fifth anniversary of
              SSS.
              <br />
              For this occasion, SSS Anniversary Party will take place during
              one of the evenings.
            </p>
          ...
          <div className="event_partner_p1">
            ...
            <div>
              <div>
                <a
                  href="http://www.anrivagroup.com/"
                  target="blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src={require("./partners/1.png")}
                    alt="general partner"
                  />
                </a>
              </div>
              <div>
                <a
                  href="https://aircairo.com/en/"
                  target="blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src={require("./partners/2.png")}
                    alt="general partner"
                  />
                </a>
              </div>
          ...
          <div className="event_partner_p1 v2">
            ...
            <div>
              <div>
                <a
                  href="https://www.softconstruct.com/"
                  target="blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src={require("./partners/3.png")}
                    alt="general partner"
                  />
                </a>
              </div>
