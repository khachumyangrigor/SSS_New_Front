...
class EgyptIndividual extends React.Component {
  ...
  handleparticipateStatus = (event) => {
    let arr =
      this.form.participateStatus !== ""
        ? this.form.participateStatus.split(",")
        : [];
  ...
  handleSubmit = () => {
    ...
    else if (compRepresent === "yes" && compRepresentText === "")
      error = "compRepresentText";
    else if (compRepresent === "yes" && compRepresentText2 === "")
      error = "compRepresentText2";
    else if (participate === "") error = "participate";
    else if (participate === "yes" && participateStatus === "")
      error = "participateStatus";
    ...
    if (error !== "") {
      ...
      fetch(
        "https://www.apis.seasidestartupsummit.com/aplications/egypt2020-individual.php",
        {
          method: "POST",
          headers: {
        ...
        .then((data) => {
          if (data.resp === "ok") {
            ...
            this.setState({
              errorSbm: "Sorry something went wrong. Please Try Again",
            });
          }
        })
        .catch((error) =>
        ...
        <div className="egipt_2020">
          ...
          <div className="part1Egypt">
            <div>
              ...
              <p>
                #SSSholidays2020 is a 7-day event which will take place in a
                resort setting, with representatives of the Startup Ecosystem of
                Armenia and a host country. During these days panel discussions
                will be organized, as well as Campfire Talks, etc.{" "}
              </p>
              <small>
                *Fill in this form to participate in #SSSholidays2020 and our
                organizers will look at your candidacy, contact you and send you
          ...
          <div className="teamleadForm_title_body">
            ...
            <p>
              Please complete the form and tell us about you as much as
              possible.
            </p>
          </div>
          ...
          >
            ...
            <div className="form_body_flex">
              <div className="form_body_grid">
                <h4 ref="compRepresent" style={{ marginBottom: "0px" }}>
                  Do you represent a Company? *
                </h4>
                <RadioGroup
                  aria-label="gender"
                  onChange={this.handleCompRepresent}
                >
                  <div className="form_body_grid">
                    <FormControlLabel
                      value="yes"
              ...
              <div
                className="form_body_flex collapseBox"
                ref="compRepresentCond"
                style={{ height: "0px", overflow: "hidden" }}
              >
                <TextField
                  ref="compRepresentText"
                  name="compRepresentText"
                  autoComplete="off"
                  onChange={this.handleBasicButtons}
                  label="Company’s Name *"
                />
                <TextField
                  ref="compRepresentText2"
                  name="compRepresentText2"
                  autoComplete="off"
                  onChange={this.handleBasicButtons}
            ...
            <div className="form_body_flex">
              <div className="form_body_grid">
                <div className="form_body_grid">
                  <h4 ref="participate">
                    Have you ever been in one of Seaside Startup Summit *
                  </h4>
                  <RadioGroup
                    aria-label="gender"
                ...
                <div className="form_body_flex" style={{ marginTop: "0px" }}>
                  <h4 ref="curentStatus">
                    Would you like to stay in a tent a day?
                  </h4>
              ...
              >
                ...
                <FormGroup>
                  <FormControlLabel
                    control={
                      <Checkbox
                        onChange={this.handleparticipateStatus}
                        value="startup"
                        color="primary"
                      />
                    }
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        onChange={this.handleparticipateStatus}
                        value="membor of a jury"
                        color="primary"
                      />
                    }
                    label="Membor Of A Jury"
                  />
                  <FormControlLabel
                    control={
                      <Checkbox
            ...
            <div className="textAreaBox">
              <div>
                <h6 ref="lasttextH">
                  What is the reason for your participation in the
                  SSSholidays2020?
                </h6>
              </div>
              <textarea
          ...
          <div className="formFootter">
            <button onClick={this.handleSubmit} ref="submitBtn">
              Apply
            </button>
