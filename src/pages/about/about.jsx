...
const About = (props) => {
    const [gallery, setGallery] = useState({
        "uae2021": ["sevan2016", "SSSholidays —", "49.jpg", "50.jpg", "https://www.youtube.com/embed/EPldXGsNEbU", "51.jpg", "52.jpg", "53.jpg", "54.jpg", "55.jpg", "56.jpg", "sevan2019"],
        "sevan2019": ["uae2021", "SEVAN STARTUP SUMMIT 2019 —", "1.jpg", "2.jpg", "https://www.youtube.com/embed/2EQFRmIHSBs", "3.jpg", "4.jpg", "5.jpg", "6.jpg", "7.jpg", "8.jpg", "sevan2018"],
        "sevan2018": ["sevan2019", "SEVAN STARTUP SUMMIT 2018 —", "9.jpg", "10.jpg", "https://www.youtube.com/embed/FkDxAiIaLzY", "11.jpg", "12.jpg", "13.jpg", "14.jpg", "15.jpg", "16.jpg", "india18"],
        "india18": ["sevan2018", "SEASIDE STARTUP SUMMIT INDIA GOA —", "25.jpg", "26.jpg", "https://www.youtube.com/embed/3l5_QQv2d2g", "27.jpg", "28.jpg", "29.jpg", "30.jpg", "31.jpg", "32.jpg", "uae18"],
        "uae18": ["india18", "SEASIDE STARTUP SUMMIT UAE RAK —", "17.jpg", "18.jpg", "https://www.youtube.com/embed/7RG0wH9t3UA", "19.jpg", "20.jpg", "21.jpg", "22.jpg", "23.jpg", "24.jpg", "sevan2017"],
        "sevan2017": ["india18", "SEVAN STARTUP SUMMIT 2017 —", "33.jpg", "34.jpg", "https://www.youtube.com/embed/30JZ1-fd-SQ", "35.jpg", "36.jpg", "37.jpg", "38.jpg", "39.jpg", "40.jpg", "sevan2016"],
        "sevan2016": ["sevan2017", "SEVAN STARTUP SUMMIT 2016 —", "41.jpg", "42.jpg", "https://www.youtube.com/embed/j2D2o7C0xoY?list=PLCcLpJIHQ5vf0Sru8mg0P7T8xWt5SiMb1", "43.jpg", "44.jpg", "45.jpg", "46.jpg", "47.jpg", "48.jpg", "uae2021"]
    });

    const [galleryArr, setGalleryArr] = useState(["sevan2016", "SEVAN STARTUP SUMMIT 2019 —", "49.jpg", "50.jpg", "https://www.youtube.com/embed/EPldXGsNEbU", "51.jpg", "52.jpg", "53.jpg", "54.jpg", "55.jpg", "56.jpg", "sevan2019"]);
    ...
    useEffect(() => {
        const handleScroll = () => {
            if (typeof window !== 'undefined' && window.innerWidth > 1024) {
                if (window.scrollY < aboutTop.current.offsetHeight - headerText.current.offsetHeight - headerText.current.offsetTop) {
                ...
                if (scrollY.current < window.scrollY) {
                    if (parseFloat(headerText.current.style.opacity) > 0) {
                        headerText.current.style.opacity = parseFloat(headerText.current.style.opacity) - 0.01;
                    }
                    scrollY.current = window.scrollY + 1;
                } else if (scrollY.current > window.scrollY) {
                    if (parseFloat(headerText.current.style.opacity) < 1 && window.scrollY < aboutTop.current.offsetHeight - headerText.current.offsetHeight - headerText.current.offsetTop) {
                        headerText.current.style.opacity = parseFloat(headerText.current.style.opacity) + 0.01;
                    }
        ...
        <>
            ...
            <div className="aboutNew">
                <div className="galleryOpen" ref={imgOpenRef} onClick={elemClose}>
                    <div className="imgClose" onClick={elemClose}><span/><span/></div>
                    <div>
                        <div className="GalleryOpenPrev" ref={GalleryOpenPrev} onClick={galleryOpenPrev}><i/></div>
                        <div className="GalleryOpenBox"><img src={require(`./img/gallery/${imgSrc}`)} alt={imgSrc}/>
                        </div>
                        <div className="GalleryOpenNext" ref={GalleryOpenNext} onClick={galleryOpenNext}><i/></div>
                    </div>
                </div>
                    ...
                    <div className="subTeam">
                        ...
                        <div className="teamImgBox">
                            <div>
                                ...
                                <p>Co-founder</p>
                                <a href="https://en.wikipedia.org/wiki/Artur_Janibekyan" target="_blank"
                            ...
                            <div>
                                ...
                                <p>Co-founder</p>
                                <a href="https://www.linkedin.com/in/hakob-hakobyan-sss/" target="_blank"
                                   rel="noopener noreferrer"><i/></a>
                            </div>
                            <div>
                                ...
                                <p>Co-founder</p>
                                <a href="https://www.linkedin.com/in/tiran-hakobyan-a74539a3/" target="_blank"
                                   rel="noopener noreferrer"><i/></a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="aboutGallery">
                    ...
                    <div className="galleryBody">
                        <div onClick={imgOpen}><Img src={require(`./img/gallery/${galleryArr[2]}`)} decode={false}
                                                    id="2"
                                                    alt="gallery"/></div>
                        <div onClick={imgOpen}><Img src={require(`./img/gallery/${galleryArr[3]}`)} decode={false}
                                                    id="3"
                                                    alt="gallery"/></div>
                        <div>
                            <iframe src={`${galleryArr[4]}`} title="frem193" frameBorder="0"></iframe>
                        </div>
                        <div onClick={imgOpen}><Img src={require(`./img/gallery/${galleryArr[5]}`)} decode={false}
                                                    id="5"
                                                    alt="gallery"/></div>
                        <div onClick={imgOpen}><Img src={require(`./img/gallery/${galleryArr[6]}`)} decode={false}
                                                    id="6"
                                                    alt="gallery"/></div>
                        <div onClick={imgOpen}><Img src={require(`./img/gallery/${galleryArr[7]}`)} decode={false}
                                                    id="7"
                                                    alt="gallery"/></div>
                        <div onClick={imgOpen}><Img src={require(`./img/gallery/${galleryArr[8]}`)} decode={false}
                                                    id="8"
                                                    alt="gallery"/></div>
                        <div onClick={imgOpen}><Img src={require(`./img/gallery/${galleryArr[9]}`)} decode={false}
                                                    id="9"
                                                    alt="gallery"/></div>
                        <div onClick={imgOpen}><Img src={require(`./img/gallery/${galleryArr[10]}`)} decode={false}
                                                    id="10" alt="gallery"/></div>
                    </div>
                    <div className="galleryFootter">
                        The photographs and video materials contained on this site are the property of Seaside Startup
                        Summit LLC and are protected by International copyright laws. All copyright, trademark, and
                        other intellectual property rights in this site, are the property of Seaside Startup Summit LLC.
                        Those persons who wish to use the photography found on this site in a commercial purpose must
                        receive written consent from Seaside Startup Summit LLC, prior to its commercial use.
                    </div>
                </div>
            </div>
        </>
