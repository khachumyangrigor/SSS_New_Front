...
class Job extends React.Component {
  constructor() {
    ...
    this.jobs = [
      ...
      },
      {
        ...
        job_desc:
          "We are currently seeking a Regional Manager to join our Business Development team. They will be responsible for developing our projects, ensuring their further growth, managing and improving career relationships within the region. ",
  ...
  winScroll = () => {
    if (window.innerWidth > 1024) {
      if (
        window.scrollY <
        this.refs.aboutTop.offsetHeight -
          this.refs.headerText.offsetHeight -
          this.refs.headerText.offsetTop
      ) {
    ...
    return (
      <Fragment>
        <Helmet>
          ...
          <meta
            name="description"
            content="WHAT IS IT ALL ABOUT and THE TEAM"
          />
        </Helmet>
        <div className="aboutNew">
          <div className={`aboutTop job ${forClassName}`} ref="aboutTop">
            ...
            <div ref="headerText">
              <h1>
                {job_name.split(" ")[0]} {job_name.split(" ")[1]} <br />{" "}
                {job_name.split(" ")[2]}{" "}
              </h1>
        ...
        <div className="jobBody">
          <div className="aboutInfo">
            <div className="aboutInfo_left">
              ...
              <p>
                {job_name === "Content Development Specialist" ? (
                  <b>(Programme Development Specialist)</b>
                ) : (
                  ""
                )}
              </p>
          ...
          <div className="mainInfo">
            <div>
              <div className="imageBox">
                <img src={require(`./img/icon/cv.png`)} alt="CV" />
              </div>
              <div className="textBox">
                <h2>How to Apply</h2>
                <p>
                  Send your CV to <a href="mailto:info@sss.am">info@sss.am</a>
                </p>
              </div>
            </div>
          </div>
