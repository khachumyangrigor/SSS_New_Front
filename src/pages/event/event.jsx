    ...
    if (window.innerWidth > 1024) {
      if (this.scrollY <= window.scrollY) {
        if (parseFloat(this.refs.headerText.style.opacity) > 0) {
          this.refs.headerText.style.opacity =
            parseFloat(this.refs.headerText.style.opacity) - 0.01;
        }
        if (
          window.scrollY <
          this.refs.headerText2.offsetTop - this.refs.headerText2.offsetHeight
        ) {
        ...
        if (
          parseFloat(this.refs.headerText.style.opacity) < 1 &&
          window.scrollY <
            this.refs.headerText2.offsetTop - this.refs.headerText2.offsetHeight
        ) {
          this.refs.headerText.style.opacity =
  ...
  submitHandler = () => {
    ...
    fetch("https://www.apis.seasidestartupsummit.com/subscribe.php", {
      ...
      .then((data) => {
        if (data.resp === "ok") {
          mailBox.value = "";
          this.setState({ mailAdded: "You are successfully subscribed." });
        } else if (data.resp === "exist") {
          mailBox.value = "";
          this.setState({ mailAdded: "This mail already exist" });
        } else {
          mailBox.value = "";
          this.setState({ mailAdded: "Something Wrong. Try again." });
        }
      })
  ...
  render = () => {
    return (
      <Fragment>
        <Helmet>
          <title>
            Check Our Upcoming and Past Events | Seaside Startup Summit
          </title>
          <meta
            name="description"
            content="SSS is the first outdoor campsite-based platform for startups that fosters intensive deal-making and conversations about current topics in entrepreneurship"
          />
          <meta
            property="og:title"
          ...
          <meta
            property="og:image"
            content="http://seasidestartupsummit.com/ogImage/event.png"
          />
          <meta
        ...
        <div className="eventNew">
          <div className="eventTop" ref="eventTop">
            <h1 ref="headerText">
              Transforming the way to build sustainable businesses and lasting
              connections
            </h1>
            ...
            <div ref="headerText2" className="eventBodyHead">
              ...
              <p>
                Seaside Startup Summit is the first outdoor campsite-based
                microacceleration platform that fosters intensive deal-making
                and immersive conversations about the hottest current topics in
          ...
          <div className="eventBody">
            ...
            <div className="eventBodyMiddle">
              ...
              <div>
                <div>
                  <img
                    src={require("./img/eventCover/sugest.png")}
                    alt="eventImg"
                  />
                </div>
                ...
                <section ref="formSec" className="form">
                  ...
                  <input
                    type="text"
                    placeholder="Suggest Partner"
                    ref="partner"
                  />
                </section>
                <p ref="formtext1" className="formP">
                  Suggest
                  <br />
                  your dream location
                </p>
            ...
            <div className="eventBodyMiddle past">
              ...
              <PastEventComponent
                ...
                locationLink={
                  "https://www.google.com/maps/place/Sevan+Startup+Summit/@40.344047,45.578228,3342m/data=!3m1!1e3!4m6!3m5!1s0x403f89d42619d199:0xab251b125c1578ac!8m2!3d40.3440465!4d45.5782279!16s%2Fg%2F11v0qtkrr8?hl=en&entry=ttu"
                }
              ...
              <PastEventComponent
                ...
                locationLink={
                  "https://www.google.com/search?newwindow=1&safe=active&sxsrf=ALeKk02wx6-2zNRiUwZ8xHYCnhyBPDcqlQ:1583939336793&q=sevan+startup+summit+map&npsic=0&rflfq=1&rlha=0&rllag=40345921,44773830,29452&tbm=lcl&ved=2ahUKEwjxs4_s2ZLoAhVM_SoKHVc7CEIQtgN6BAgLEAQ&tbs=lrf:!1m4!1u3!2m2!3m1!1e1!1m4!1u2!2m2!2m1!1e1!2m1!1e2!2m1!1e3!3sIAE,lf:1,lf_ui:2&rldoc=1#rlfi=hd:;si:;mv:[[40.56979154858928,45.22049290283203],[40.43613241385136,44.895709577636715],null,[40.50299527241559,45.05810124023437],12]"
                }
                locationTitle={"Lake Sevan, Armenia"}
          ...
          <div className="eventJoin">
            ...
            <div className="joinText">
              In order to get the latest updates from around the world you can
              ...
              <section className="form">
                <div>
                  ...
                  <input
                    ...
                    ref="email"
                    type="text"
                    placeholder={this.state.mailAdded}
                  />
                </div>
