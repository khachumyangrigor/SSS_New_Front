...
class News extends React.Component {
  ...
  handelNewsFatch() {
    const API_SPEAKER_URL =
      "https://www.apis.seasidestartupsummit.com/news/?method=getNews&id";
  ...
  render = () => {
    const API_IMG_URL =
      "https://www.staff.seasidestartupsummit.com/user/news/img/newsimg";
    ...
    return (
      <Fragment>
        <Helmet>
          ...
          <meta
            name="description"
            content="Stay updated in with our blog.News and announcements of events."
          />
          <meta
            property="og:title"
            content="Startup Blog | Seaside Startup Summit"
          />
          <meta
            property="og:url"
            content={`https://www.seasidestartupsummit.com/blog`}
          />
          <meta
        ...
        <div className="newsBox" ref="news">
          ...
          <div className="newsMiddle">
            {/* <InfiniteScroll
              ...
              endMessage={
                <p className="loader">
                  Congratulations! You have reached to the end.
                </p>
              }
            >
              {news.map((newsItem) => (
                <Link to={`/blog/${newsItem.url}`} key={newsItem.id}>
                  <div className="newsItem">
                    <div className="image">
                      <img
                        src={`${API_IMG_URL}/${newsItem.imgHead}`}
                        alt="News"
                      />
                    </div>
                    <div className="newsItemFooter">
                      <div className="title">
                        ...
                        <i>
                          ...
                          <div>
                            <FacebookShareButton
                              url={`https://www.seasidestartupsummit.com/blog/${newsItem.url}`}
                            >
