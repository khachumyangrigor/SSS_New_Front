...
class UpcommingNew extends React.Component {
  ...
  render = () => {
    ...
    if (event !== "" && event == "sevan2020")
      if (IS_CLIENT) return <Redirect to={`./sevan-2022`} />;
    if (event !== "" && event !== "sevan-2022")
    ...
    if (subepage === "speakers") return <SpeakersPage />;
      ...
      return (
        <Fragment>
          <Helmet>
            <title>Sevan Startup Summit 2022 | Seaside Startup Summit</title>
            <meta
              name="description"
              content="Sevan Startup Summit 2022 will be held at Sevan seashore from July 24 to July 30"
            />
            <meta
              property="og:title"
              content="Sevan Startup Summit 2022 | Seaside Startup Summit"
            />
            <meta
              property="og:url"
              content={`https://www.seasidestartupsummit.com/upcoming-events/sevan-2022`}
            />
            <meta
              property="og:image"
          ...
          <div className="upcommingNew">
            ...
            <div className="firstPageHeader" ref="topMenu">
              ...
              <div className="firstPageHeaderRight">
                ...
                <div
                  className="minmenuLastIcon"
                  ref="submenuIcon"
                  onClick={(e) => this.submenuOpen()}
                >
                  {" "}
                  <span /> <span /> <span />
                </div>
              ...
              <div
                className="minmenuBox"
                ref="menuBox"
                onClick={this.menueClose}
              >
                <div className="firstPageHeaderMiddle">
                  <ul>
                    <li>
              ...
              <div className="subMnue" ref="subMenu" onClick={this.menuCloase}>
                <ul>
                  <li>
                    <Link to={`/upcoming-events/${event}/our-credo`}>
                      Our Credo
                    </Link>
                  </li>
                  <li>
                    <Link to={`/upcoming-events/${event}/citizen`}>
                      types of participation
                    </Link>
                  </li>
                  <li>
                    <Link to={`/upcoming-events/${event}/program`}>
                      OUR PROGRAMME
                    </Link>
                  </li>
                  <li>
                    <Link to={`/upcoming-events/${event}/how-to-reach-us`}>
                      How to reach us
                    </Link>
                  </li>
                  <li>
                    <Link to={`/upcoming-events/${event}/important-to-know`}>
                      Important to know
                    </Link>
                  </li>
                </ul>
            ...
            <div className="upcommingSuggest">
              ...
              <p>
                ...
                accepted teams are distributed into either Starter (idea stage)
                or Booster (early stage) programmes based on their levels of
                development and fields of operation*.
              </p>
            </div>
