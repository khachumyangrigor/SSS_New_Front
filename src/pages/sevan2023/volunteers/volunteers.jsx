              ...
              <div className="card">
                <div className="content">
                  ...
                  <div className="back">
                    <h4>GRAND ENTRY</h4>
                    <p>
                      These volunteers assist with grand entry procedures,
                      requirements, and activities. Volunteers help with
                      participant passes and escorts to the event grounds. They
                      also are responsible for shuttle services.
                    </p>
                  </div>
                </div>
              </div>
              <div className="card">
                <div className="content">
                  ...
                  <div className="back">
                    <h4>MEET AND GREET TEAM</h4>
                    <p>
                      The team is responsible for organizing the meet and greet
                      of the international guests, speakers, and special
                      attendees, escorting them from airport and/or other
                      transportation hubs to the venue and/or hotels.
                    </p>
                  </div>
                </div>
              </div>
              <div className="card">
                <div className="content">
                  ...
                  <div className="back">
                    <h4>CONTENT RELATED SERVICES</h4>
                    <p>
                      Content team volunteers are responsible for the technical
                      management of the auditoriums and campfires. They support
                      speakers, mentors, startuppers, and jury by guiding
                      through the agenda and providing content-related
                      information.
                    </p>
                  </div>
                </div>
              ...
              <div className="card">
                <div className="content">
                  ...
                  <div className="back">
                    <h4>DIRECTIONS & ASSISTANCE</h4>
                    <p>
                      These Volunteers are responsible for assisting attendees
                      with information and directions around the event grounds.
                      They are responsible for the care of lost children, for
                      the operation of the lost and found room, and distribution
                      of the visitors guide and agenda.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                <div className="content">
                  ...
                  <div className="back">
                    <h4>MEDIA TEAM</h4>
                    <p>
                      Media team is responsible for content writing during the
                      talks, workshops, and masterclasses. They are also
                      responsible for interviewing various participants, such as
                      startupers, speakers, and/or special guests.
                    </p>
                  </div>
                </div>
              </div>
              <div className="card">
                <div className="content">
                  <div className="front">
                    <div>
                      <img
                        src={require("./img/icons/type6.png")}
                        alt="opportunities"
                      />
                    </div>
                  ...
                  <div className="back">
                    <h4>Photo-Video Production</h4>
                    <p>
                      These volunteers are responsible for photo and video
                      shooting of various activities during the event. They must
                      follow the agenda and prepare materials covering each
                      activity.
                    </p>
                  </div>
                </div>
              ...
              <div className="card">
                <div className="content">
                  <div className="front">
                    <div>
                      <img
                        src={require("./img/icons/type7.png")}
                        alt="opportunities"
                      />
                    </div>
                  ...
                  <div className="back">
                    <h4>Technical support</h4>
                    <p>
                      The technical team is responsible for the conduction of
                      various sets of technical operations, such as warehouse
                      management, parking zone control, beach maintenance. These
                      volunteers also act as a quick response team.
                    </p>
                  </div>
                </div>
              </div>
              <div className="card">
                <div className="content">
                  <div className="front">
                    <div>
                      <img
                        src={require("./img/icons/type8.png")}
                        alt="opportunities"
                      />
                    </div>
                    <h4>Entertainment</h4>
                  ...
                  <div className="back">
                    <h4>Entertainment</h4>
                    <p>
                      These volunteers work under the direct supervision of the
                      entertainment Teamlead and are responsible for the
                      organization of various sport, art & gaming events, and
                      contests. They also act as a support team for the DJs and
            ...
            <div className="guidItems">
              ...
              >
                ...
                <p>
                  ...
                  and top applicants are selected and distributed into working
                  groups
                </p>
              </div>
              <i ref="i3" />
            ...
            <div>
              <div>
                <p className={`${this.state.textOpeningWhatIs}`}>
                  {this.state.person.text}
                </p>
                <button
                  className="textOpening"
                  onClick={() => {
                    this.textOpeningWhatIs();
                  }}
                >
                  See {this.state.textOpeningWhatIs}
                </button>
                <div>
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <img src={require("./img/icons/fb.png")} alt="fb" />
                  </a>
                  <div>
                ...
                <div>
                  <i onClick={this.handelPrevPerson} />
                  <span>{this.state.imgnum}/20</span>
                  <i onClick={this.handelNextPerson} />
                </div>
              </div>
              <div>
                <img
                  src={require(`./img/people/${this.state.person.img}`)}
                  alt="Volunter"
                />
              </div>
            </div>
