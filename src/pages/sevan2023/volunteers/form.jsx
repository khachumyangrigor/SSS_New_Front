...
class ValunteersForm extends React.Component {
  ...
  handleCurrentStatus = (event) =>
    (this.volunteers.currentStatus.times = event.target.value);
  ...
  handleLicense = (event) =>
    (this.volunteers.drivingLicense = event.target.value);

  handleCar = (event) => (this.volunteers.carOwn = event.target.value);

  handlePreviouslyEvent = (event) =>
    (this.volunteers.pevEvent_answer = event.target.value);
  ...
  handleSubmit = () => {
    ...
    else if (pevEvent_answer === "yes" && pevEvent_text === "")
      error = "mention";
    ...
    if (error !== "") {
      ...
      fetch(
        "https://www.apis.seasidestartupsummit.com/aplications/volunteers.php",
        {
          method: "POST",
      ...
      <Fragment>
        ...
        <div className="volunteersForm_title">
          <h3 className="subtitle">
            Relevant Volunteer Experience & Motivation Questions
          </h3>
        </div>
        <div className="form_body">
          <div className="form_body_grid">
            <h4 ref="previouslyEvent">
              Have you previously taken part in those kind of events? *
            </h4>
            <RadioGroup
              aria-label="previouslyEvent"
              name="previouslyEvent"
              onChange={this.handlePreviouslyEvent}
            >
              <FormControlLabel
                value="yes"
                control={<Radio color="primary" />}
