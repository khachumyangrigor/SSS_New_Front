      ...
      <div className="firstPageHeader" ref="topMenu">
        ...
        <div className="subMnue" ref="subMenu" onClick={this.menuCloase}>
          <ul>
            ...
            <li>
              <Link to={`/upcoming-events/${event}/firecode-marathone`}>
                Firecode marathone
              </Link>
            </li>
            <li>
              <Link to={`/upcoming-events/${event}/our-credo`}>Our Credo</Link>
            </li>
            <li>
              <Link to={`/upcoming-events/${event}/platform-structure`}>
                Platform Structure
              </Link>
            </li>
            <li>
              <Link to={`/upcoming-events/${event}/speakers-part`}>
                Speakers
              </Link>
            </li>
            <li>
              <Link to={`/upcoming-events/${event}/investors-part`}>
                Investors
              </Link>
            </li>
            <li>
              <Link to={`/upcoming-events/${event}/our-Alumni`}>
                Our Alumni
              </Link>
            </li>
            <li>
