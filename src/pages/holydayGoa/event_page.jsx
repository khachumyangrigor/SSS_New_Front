    ...
    return (
      <div>
        <Helmet>
          ...
          <meta
            name="description"
            content="SSSholidays is one of the Seaside Startup Summit's new formats, which will take place in the India for the first time."
          />
          <meta
          ...
          <meta
            property="og:title"
            content="SSS Holidays India Vizag | Seaside Startup Summit"
          />
          <meta
            property="og:url"
            content={`https://www.seasidestartupsummit.com/sss-holidays-india-vizag`}
          />
          <meta
            property="og:image"
            content="http://seasidestartupsummit.com/ogImage/sss-holidays-india-vizag.png"
          />
          <meta
            property="og:image:secure_url"
            content="https://seasidestartupsummit.com/ogImage/sss-holidays-india-vizag.png"
          />
        </Helmet>
        <div className="goaHoliday2022">
          <div className="egiptbnaer">
            <div>
              ...
              <h2>
                Sagar-Nagar beach, India <br className="dateBreakMobile" />{" "}
                February 13-18, 2023
              </h2>
            </div>
          </div>
          ...
          <div className="aboutInfo">
            <div className="aboutInfo_left">
              ...
              >
                ...
                formats, which previously took place once in UAE. This time the
                event will be held in India, Vizag. SSSholidays Vizag is going
                to be the most awaited event of the year for the representatives
                of the Startup Ecosystem of Armenia, India and other countries.
                It will be held in Radisson Blu Resort Visakhapatnam. There will
                be a specially developed educational programme, which will
                include Panel Discussions, Mentorship Sessions, Campfire
                Talks,and Startup Battles. Participation formats are designed
                for startups, companies, and individuals as well.
                <br />
                <span style={{ display: "block", marginTop: "26px" }} />
                Fill in this form to participate in #SSSholidays and our
                organizers will reach out to you and send you more detailed
            ...
            <div className="aboutInfo_right">
              ...
              <iframe
                title="infoFrame"
                src="https://www.youtube.com/embed/EBes_PWzuO4"
                frameBorder="0"
          ...
          <div className="event_violet">
            ...
            <p>
              SSSholidays India Vizag is already the second event in this format
              and it is obviously becoming an annual phenomenon. We are sure
              that SSSholidays India Vizag will raise your standards about
              high-quality rest and will be as unique and unprecedented as the
              main format of Seaside Startup Summit.
            </p>
          </div>
        </div>
      </div>
