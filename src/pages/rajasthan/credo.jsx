...
const data = [
  ...
  },
  {
    ...
    back: {
      title: "Learn",
      description: [
        "Micro-acceleration Program",
        "One-on-one Mentoring and Guidance",
        "Expert-Led Campfire Talks",
  ...
  },
  {
    ...
    back: {
      title: "Have Fun",
      description: [
        "Tent Life Unique Experience",
        "Team-Building Adventures",
        "Water Sports Activities",
        "Live Music and Night Parties",
      ],
    },
    color: "#F68C36",
  },
...
function Credo() {
  ...
  return (
    <div className="credo uae-credo sevan24-credo sevan2025Credo wb-background-gray">
      <h2>Why Participate as a Startup</h2>
      <p>
        {width > 1024
          ? "— SSS provides the following key benefits —"
          : "SSS provides the following key benefits"}
      </p>
        ...
        <div className="card">
          <div className="content">
            <div className="front">
              <div>
                <img
                  src={require("./img/disignIcon/know/credo5.png")}
                  alt="opportunities"
                />
              </div>
        ...
        <div className="card">
          <div className="content">
            <div className="front">
              <div>
                <img
                  src={require("./img/disignIcon/know/credo6.png")}
                  alt="opportunities"
                />
              </div>
        ...
        <div className="card">
          <div className="content">
            <div className="front">
              <div>
                <img
                  src={require("./img/disignIcon/know/credo7.png")}
                  alt="opportunities"
                />
              </div>
        ...
        <div className="card">
          <div className="content">
            <div className="front">
              <div>
                <img
                  src={require("./img/disignIcon/know/credo8.png")}
                  alt="opportunities"
                />
              </div>
                ...
                <div className="wb-front">
                  ...
                  <ul className={"slideCard" + data[activeCardIndex].id}>
                    {data[activeCardIndex].back.description.map((li, i) => {
                      return <li key={`credo-2024-${i}`}>{li}</li>;
                    })}
                  </ul>
                </div>
              </div>
