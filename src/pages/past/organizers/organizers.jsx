...
const Organizers = (props) => {
  ...
  //   if (location === "/sevan19/" || location === "/sevan19")
  // return <OrganizersSevan19 />;
  //   else if (location === "/sevan18/" || location === "/sevan18")
  // return <OrganizersSevan18 />;
  //   else if (location === "/sevan17/" || location === "/sevan17")
  // return <OrganizersSevan17 />;
  //   else if (location === "/sevan16/" || location === "/sevan16")
  // return <OrganizersSevan16 />;
  // else if (location === '/uae18/' || location === '/uae18') return <OrganizersRak18 />;
  //   else if (location === "/india18/" || location === "/india18")
  // return <OrganizersGoa18 />;
};
