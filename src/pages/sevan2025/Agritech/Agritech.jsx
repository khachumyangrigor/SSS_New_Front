      ...
      <div className="agritech-content">
        ...
        <div className="agritech-mainContent">
          ...
          <div className="agritech-info">
            <p>
              For the first time, within the framework of Sevan Startup Summit
              2025, we will have a separate event dedicated to AgriTech
              industry: #SevanAgriTechSummit will be held from July 24-27.
            </p>
            <p>
              This regional event will bring together AgriTech startups,
              agriculturists and other interested people, by providing them an
              exceptional platform to explore emerging trends and best
              practices, forge strategic partnerships, and develop tailored
              solutions to drive innovation and excellence.
            </p>
            <p>
              <b>Three-day high-level conference</b>
              The conference and Agrithon will cover a range of critical topics
              including Digital Farming Solutions, Advanced Digital Technologies
              in Agriculture, Advanced Agrobiotechnologies and more.
            </p>
            <p>
              <b>Agrithon Startup Competition</b>
              The Agrithon is an exciting startup competition where agri-tech
              enthusiasts will have the opportunity to showcase groundbreaking
              solutions, compete for prestigious prizes, and gain industry
              recognition.
            </p>
            <p>
              <b>Awards Ceremony</b>
              The Awards Ceremony will celebrate excellence, honoring leaders at
              the forefront of agricultural innovation and sustainability.
            </p>
          </div>
        </div>
