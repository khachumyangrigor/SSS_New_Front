        ...
        <div className="upcommingGetAcces sevan24-getAccess">
          <div className="upcommingGetAcces_left">
            ...
            <p className={`${this.state.textOpeningWhatIs}`}>
              ...
              2025 unfolds as the sixth edition of the region's largest annual
              ...
              SSS25 is not merely an event; it's an investment and deal-making
          ...
          <div className="upcommingGetAcces_right">
            {/*<iframe*/}
            {/*  src="https://www.youtube.com/embed/0AbpvX40-fY?si=8nOAxwgNOAO-u3fU"*/}
