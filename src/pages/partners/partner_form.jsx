...
class PartnerForm extends React.Component {
  ...
  handleSubmit = () => {
    ...
    if (error !== "") {
      ...
      fetch(
        "https://www.apis.seasidestartupsummit.com/aplications/partner_form.php",
        {
          method: "POST",
          headers: {
      ...
      <Fragment>
        <div className={`partner_form_box ${this.state.formOpen}`}>
          <div className="partner_form">
            ...
            <div
              className={`partner_form_success ${
                this.state.errorSbm === "succeed" ? "open" : "5"
              } `}
            >
              <img src={require("./img/icons/success.png")} alt="Success" />
              <p>
                Your application is taken forward. <br /> SSS Team will contact
                you soon
              </p>
            </div>
          </div>
