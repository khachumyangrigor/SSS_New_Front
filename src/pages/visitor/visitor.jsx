...
class Visitor extends React.Component {
  ...
  appClick = () => {
    ...
    if (/android/i.test(userAgent)) {
      window.open(
        "https://play.google.com/store/apps/details?id=ru.deltapay.puntopago.telcell&hl=en_US",
        "_blank"
      );
    } else if (/iPad|iPhone|iPod/.test(userAgent) && !window.MSStream) {
      window.open(
        "https://apps.apple.com/am/app/telcell-wallet/id1324511564",
        "_blank"
      );
    } else {
    ...
    return (
      <Fragment>
        ...
        <div className="visitorSection">
          <section
            ref={(section) => {
              this.thisPart = section;
            }}
          >
            <h2>
              BOOK<span> YOUR</span> VISITOR PASS
            </h2>
            <h1>
              <span>for</span> #SSS19
            </h1>
            ...
            <div className="passBox">
              ...
              <div className="passFooter">
                ...
                <div className="passDesc">
                  Leisure activities with 20% discount
                </div>
            ...
            <div className="visitorMiddleRigth">
              <div className="visitorFooter">
                <div className="visitorFooterPart">
                  <div className="text">
                    The passes may be purchased only via{" "}
                  ...
                  <div className="image image2">
                    <a
                      href="https://apps.apple.com/am/app/telcell-wallet/id1324511564"
                      target="_blanck"
                      rel="dofollow"
                    >
                    ...
                    <a
                      href="https://play.google.com/store/apps/details?id=ru.deltapay.puntopago.telcell&hl=en_US"
                      target="_blanck"
                      rel="dofollow"
                    >
                ...
                <div className="visitorFooterPart">
                  <div className="text2">
                    * All the visitors should follow the{" "}
                    <a
                      href="https://seasidestartupsummit.com/Visitors_T&C.pdf"
                      target="_blanck"
                      rel="dofollow"
                    >
                      {" "}
                    ...
                    otherwise we’ll need to dismiss their passes.
                  </div>
                </div>
              </div>
              <div className="passBoxMini">
                <div className="passHead">
                  +24 HOURS UPGRADE{" "}
                  <span onClick={this.openFooter}>{this.state.openIcon}</span>
                </div>
                <div className="passMiddle">
                  <div className="passTime">8 PM – 8 PM (next day)</div>
                  <div className="passPrice">
                    22,000<span>AMD</span>
                  </div>
                </div>
              ...
              <div className="passBoxMini">
                <div className="passHead">
                  FULL PASS{" "}
                  <span onClick={this.openFooter2}>{this.state.openIcon2}</span>
                </div>
                <div className="passMiddle">
                  <div className="passTime">JUL 28 - AUG 3</div>
                  <div className="passPrice">
                    225,000<span>AMD</span>
                  </div>
                </div>
                <div className={`passFooter ${this.state.passFooter2}`}>
                  <div className="passDesc">
                    Individual tent and sleeping bag
                  </div>
                  <div className="passDesc">
                    Opportunity to take part in all events
                  </div>
                </div>
              </div>
            </div>
