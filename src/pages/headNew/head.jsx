    ...
    return (
      <div className="firstPageHeader" ref="topMenu">
        ...
        <div className="firstPageHeaderMiddle">
          <ul>
            <li>
              <Link to="/events" ref="eventLi">
                Events
              </Link>
            </li>
            <li>
              <Link to="/about-us" ref="aboutLi">
                About us
              </Link>
            </li>
            {/* <li><Link to="/startups">Startups</Link></li> */}
            <li>
              <Link to="/partners" ref="partnersLi">
                Partners
              </Link>
            </li>
            <li>
              <Link to="/merch" ref="merchLi">
                Merch
              </Link>
            </li>
            <li>
              <Link to="/blog" ref="blogLi">
                Blog
              </Link>
            </li>
