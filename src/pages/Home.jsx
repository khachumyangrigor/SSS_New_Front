...
function HomePage() {
  return (
    <Fragment>
      <Helmet>
        <title>
          The first non-formal Startup event | Seaside Startup Summit
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="The first non-formal Startup event | Seaside Startup Summit"
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://www.seasidestartupsummit.com/`}
        />
        <meta
          property="og:image"
          content={`http://seasidestartupsummit.com/ogImage/home.png`}
        />
        <meta
          property="og:description"
          content="Seaside Startup Summit is a platform that attracks leading angels,venture capitalists,entrepreneurs and transform their environment via entrepreneurship."
      ...
      <main className="firstPageNew">
        ...
        <Stats
          statsData={statsData}
          statsTitle={"Seaside Startup Summit shapes dreams of millions"}
        />
        <FootPrint />
        <Accelerators />
        <JoinUs />
