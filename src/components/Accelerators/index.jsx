...
const Accelerators = () => {
    ...
    return (<section className="firstPagePartners">
        <div className="partnersMiddlle">
            <div className="partnersMiddlleLeft">
                <div className="partnersTitle">We have <br/> cooperated with</div>
                <div className="partnersMiddlleLeftText">Our Booster micro-acceleration program is run
                    in cooperation with leading accelerators.
                </div>
            </div>
